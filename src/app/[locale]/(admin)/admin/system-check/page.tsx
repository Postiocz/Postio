...
function ServiceRow({
  ...
  return (
    <div className="flex items-center justify-between rounded-[20px] border border-white/10 bg-[#09090b]/80 px-5 py-4 backdrop-blur-xl transition-all duration-200 hover:border-white/20">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-white">{translatedLabel}</p>
          {service.connected && (
...
export default async function AdminSystemCheckPage({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Summary card */}
      <div className="rounded-[20px] border border-white/10 bg-[#09090b]/80 p-5 backdrop-blur-xl">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-[14px] bg-indigo-500/20">
