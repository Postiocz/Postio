  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-w-3xl min-w-[600px] p-0 overflow-hidden"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 pb-8">
          ...
          <div className="relative group/pro">
            ...
            <div className="relative h-full rounded-[20px] border border-white/10 bg-white/[0.02] dark:bg-white/[0.02] backdrop-blur-xl p-6 flex flex-col">
              {/* Badge */}
              <div className="mb-5">
                <Badge
                  variant="outline"
          ...
          <div className="relative group/per">
            <div className="relative h-full rounded-[20px] border border-white/5 bg-white/[0.01] backdrop-blur-xl p-6 flex flex-col">
              {/* Badge */}
              <div className="mb-5">
                <Badge
                  variant="outline"
